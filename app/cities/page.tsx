...
<section className="innerHero compactHero hasHeroArtwork"><div className="blob blobTwo"/><p className="eyebrow">MARKET BY MARKET</p><h1>CHOOSE<br/><span>YOUR CITY.</span></h1><p className="innerLead">Pakistan&apos;s property market is local. Our matching model starts with the city, then narrows to the actual area or society.</p><HeroArtwork src="/images/heroes/cities.webp" alt="Major property markets connected across Pakistan" priority/></section>
