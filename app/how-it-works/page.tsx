...
<section className="innerHero"><div className="blob blobOne"/><p className="eyebrow">THE SYSTEM</p><h1>LESS NOISE.<br/><span>MORE INTENT.</span></h1><p className="innerLead">We turn property inquiries into structured opportunities before they reach participating realtors.</p><div className="scrollCue">THE FLOW <ArrowDownRight/></div></section>
