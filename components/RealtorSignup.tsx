...
export function RealtorSignup(){
  ...
  async function submit(e:React.FormEvent){
    ...
    try{
      ...
      const r=await fetch("/api/realtors",{method:"POST",headers:{"content-type":"application/json",authorization:`Bearer ${token}`},body:JSON.stringify({...profile,termsAccepted:true})});
