...
import { ArrowUpRight, Check, Flame, LockKeyhole, MapPin } from "lucide-react";
...
<section className="betaBanner"><p className="eyebrow">BETA ACCESS</p><h2>PACKAGES COME AFTER<br/><span>WE PROVE VALUE.</span></h2><p>Monetization remains disabled during beta while we measure lead quality, claim behavior and real conversion outcomes. Subscription, credit and territory rules can then be activated around actual usage.</p><div><CTAButton href="/join-realtor">CREATE REALTOR ACCOUNT</CTAButton><a className="textArrow" href="/login">LOGIN <ArrowUpRight/></a></div></section>
<Footer/></main>}
