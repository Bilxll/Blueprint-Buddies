...
Packages:["id","name","credits","pricePkr","active","mode","createdAt","updatedAt"],Subscriptions:["id","realtorId","packageId","status","mode","startedAt","renewsAt","createdAt","updatedAt"],
Notifications:["id","userId","type","title","message","read","createdAt"],AuditLog:["id","actorUid","action","entityType","entityId","payload","createdAt"],Settings:["key","value","updatedAt"]};
